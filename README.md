...
- 회고와 문서화를 좋아하는 개발자 최수연입니다👩🏻‍💻
- Technical Writing, Interactive Web, UI & UX, Refactoring에 관심이 많아요 🔍
- TIL, 회고, 인사이트 등 다양한 <a href='https://suyeon-dev.tistory.com' target='_blank'>기술 블로그</a> 글을 작성하고 있어요✍🏻
...
|         출시          | 구분 |                         서비스명                         |             소개              |   비고    |
| :-------------------: | :--: | :------------------------------------------------------: | :---------------------------: | :-------: |
| <sub>2024.12.30</sub> |  팀  | [Cobra09🛍️](https://github.com/suyeon-dev/Cobra09market) |       공동 구매 쇼핑몰        |  운영 중  |
| <sub>2023.09.19</sub> |  팀  |  [Healthier🏃🏻‍♀️](https://github.com/suyeon-dev/Healthier)  | 운동일지 & 습관 형성 커뮤니티 | 배포 종료 |
...
<details>
<summary>Blog Highlihgts</summary>
</details>
